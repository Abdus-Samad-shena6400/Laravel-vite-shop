<template>
    <div class="p-6">
        ...
        <div class="bg-white rounded-xl shadow p-4 mb-6">
            <input type="text" placeholder="Search brand..." v-model="search"
        ...
        <div v-else class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr v-for="brand in brands" :key="brand.id" class="border-t hover:bg-gray-50">

                        <img :src="brand.image
                            ? `http://localhost:8000/storage/${brand.image}`
                        ...
                        <td class="p-4">
                            ...
                            <span class="px-3 py-1 rounded-full text-sm" :class="brand.status
                        ...
                        <td class="p-4">
                            ...
                            <div class="flex justify-center gap-2">
                                ...
                                <button @click="confirmDelete(brand)" :disabled="deleting"
        ...
        <!-- Pagination -->
        <div v-if="!loading && brands.length > 0" class="bg-white rounded-xl shadow p-4 mt-6">
            <div class="flex items-center justify-between">
                <div class="text-gray-600">
                    Showing {{ (currentPage - 1) * 4 + 1 }} to {{ Math.min(currentPage * 4, total) }} of {{ total }} brands
                </div>
                <div class="flex gap-2">
                    <button
                        @click="currentPage--; getBrands()"
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
            <div class="bg-white rounded-xl shadow-xl w-[420px] p-6">
                ...
                <div class="flex justify-end gap-3 mt-8">
                    ...
                    <button @click="deleteBrand" class="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded">
                        Delete
                    </button>
                </div>
            </div>
...
const deleteBrand = async () => {
    deleting.value = true
    try {
        await axiosClient.delete(`/brands/${selectedBrand.value.id}`)
